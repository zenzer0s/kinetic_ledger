...
final newsProvider = FutureProvider.autoDispose<List<EnrichedArticle>>((
  ref,
) async {
  ...
  final sentiments = await ref.read(cerebrasProvider).classifyBatch(headlines);
...
final calendarProvider = FutureProvider.autoDispose<List<EconomicEvent>>((
  ref,
) async {
  ...
  if (events.isNotEmpty) {
    ...
    ns.scheduleCalendarAlerts(events, settings);
    ns.scheduleDailyDigest(events, settings);
  }
